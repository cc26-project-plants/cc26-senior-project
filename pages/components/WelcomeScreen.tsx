        ...
        {userData.plantName.map((plant: string, index: number) => {
          return (
            ...
            <div
              ...
              key={index}
              className="bg-aloe scale-100  bg-center bg-cover w-52 h-72 text-center rounded-xl shadow-lg  border-white border-5 cursor-pointer transition duration-300 hover:scale-105 flex flex-col-reverse "
            >
