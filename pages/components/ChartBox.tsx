...
const ChartBox = () => {
  ...
  return (
    <div className="font-sans flex flex-col w-full bg-roppongi-200 shadow-gray-400 shadow-lg md:pt-12 pl-1 pr-1 md:pl-0 md:pr-0">
      <div className="flex flex-row md:justify-around md:-mt-4">
        <button onClick={displayLight} className="chartBtn">
          Light
        </button>
        <button onClick={displayTemp} className="chartBtn">
          Temperature
        </button>
        <button onClick={displaySoilWater} className="chartBtn">
          Soil Moisture
        </button>
        <button onClick={displayHumidity} className="chartBtn">
          Humidity
        </button>
      </div>
      <div className="flex flex-row justify-center">
        <div
          className="w-screen md:w-4/5 bg-roppongi-50 shadow-lg shadow-gray-700 rounded-lg
                        border-8 border-roppongi-50 md:border-4 md:border-white md:px-8 md:py-6 mt-7 md:mt-11
                        "
        >
