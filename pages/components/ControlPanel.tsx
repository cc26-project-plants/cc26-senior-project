...
const ControlPanel = () => {
  ...
  return (
    <div className="flex justify-center items-center font-sans w-full bg-roppongi-200 shadow-gray-300 shadow-lg inset-0">
      <div className="flex flex-col justify-around items-center md:flex-row place-content-center md:bg-roppongi-300 md:w-8/12  md:h-96 innset-0 shadow-buttoncolor-350 md:shadow-xl rounded border-white  md:-mt-16 mb-10">
        <div className="w-96 md:w-4/12 md:h-60 md:my-auto bg-roppongi-100 shadow-lg flex flex-column  shadow-gray-600 rounded-lg p-6 mt-8">
          <svg
            width="180pt"
            height="150pt"
            version="1.1"
          ...
          >
            <path
              transform="matrix(5.7143 0 0 5.7143 112.71 0)"
              d="m40.39 74.69 9.9395 2.3099s1.7603 0.62002 1.7603-1.5497v-0.19004c0-2.61 0.49014-3.7898 5.2097-8.8901h6.84e-4c5.8153-4.5438 9.1499-11.562 8.9995-18.94 0-8.8833-4.7394-17.092-12.433-21.533-7.6932-4.442-17.171-4.442-24.865 0-7.6932 4.4413-12.433 12.65-12.433 21.533-0.077247 7.363 3.243 14.35 9.0002 18.94 4.7202 5.1003 5.17 6.2802 5.2097 8.8901v1.2599c0 1.2899-0.28027 2.4302 1.1901 2.88l19.17 4.2198"
              fill="none"
              stroke="#000"
              strokeLinecap="round"
          ...
          <div className="flex flex-row justify-center gap-2">
            <h2 className=" text-3xl text-center text-roppongi-900 select-none">
              Light
            </h2>
        ...
        <div className="w-96 md:w-4/12 md:h-60 md:my-auto bg-roppongi-100 shadow-lg flex flex-column shadow-gray-600 rounded-lg p-6 mt-8">
          ...
          <div className="flex flex-row justify-center gap-2">
            <h2 className="text-3xl text-roppongi-900 select-none">Water</h2>
            <input
              type="checkbox"
              className="toggle toggle-lg toggle-accent"
              onChange={() => {
