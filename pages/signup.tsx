...
{
  /* <div className="bg-loginBg h-screen w-screen flex items-start">
      <div className="w-1/6"></div>
      <div className="bg-gray-400 bg-opacity-50 flex pl-12 pr-12 pt-2 rounded-md mt-6 outline outline-white min-w-fit min-h-fit w-fit h-fit ">
